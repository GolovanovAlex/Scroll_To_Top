...
[Demo Link <br>![CodePen](https://img.shields.io/badge/Codepen-000000?style=for-the-badge&logo=codepen&logoColor=white)](https://codepen.io/AlexGolovanov/pen/XWYYZwW)

## Info

![Gifweb](readme/gif.webp)

Создано на основе ролика с YouTube канала [Просто: разработка](https://www.youtube.com/@user-bm1pl3wu8o/videos)

Для обучения и отработки работы c **CSS**, **SVG** и **JavaScript**.  
Кнопка ScrollToTop c отображение прокрутки сайта.
